...
This reference supports the `result-reporting` bundle. Use it when the core `SKILL.md` workflow needs a sharper checklist, a stronger false-positive boundary, or a clearer evidence rule for the current case.

## Pattern Focus

Primary pattern: skill coverage reporting.

## Signals to Look For

- Module-to-skill mapping
- Support skill attachment
- Expected artifacts
- Executed modules
