...
This reference supports the `config-audit` bundle. Use it when the core `SKILL.md` workflow needs a sharper checklist, a stronger false-positive boundary, or a clearer evidence rule for the current case.

## Pattern Focus

Primary pattern: config risk separation.
